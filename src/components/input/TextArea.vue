  ...
  >
    ...
    <div class="relative" :class="horizontal ? 'flex-1' : ''">
      <textarea
        ...
        :class="`${classInput} ${error && 'border-red-500'} bg-transparent border border-light px-2 text-light rounded-lg input-control block w-full focus:outline-none pt-3 resize-none`"
        :value="modelValue"
